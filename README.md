...
3. أضف الأعمدة لكل ورقة كما هو موضح في `google-sheets-setup.md`
...
2. عدّل `api-config.js` وأضف URL الـ Google Apps Script
3. حمّل الملفات إلى Vercel أو أي استضافة
